...
$future1 = $runtime1->run(function($url, $column_numbers_to_scrape, $xpaths_of_elements_to_click_in_the_table, $xpaths_to_scrape_in_new_pages, $rows, $text_of_next_btn, $page_moving_times){
  ...
  return $scraped_data;
}, array($url, $column_numbers_to_scrape, $xpaths_of_elements_to_click_in_the_table, $xpaths_to_scrape_in_new_pages, $rows, $text_of_next_btn, $page_moving_times_in_5_threads[0]));
...
if ($pages >= 2) {
  $future2 = $runtime2->run(function($url, $column_numbers_to_scrape, $xpaths_of_elements_to_click_in_the_table, $xpaths_to_scrape_in_new_pages, $rows, $text_of_next_btn, $page_moving_times){
    ...
    return $scraped_data;
  }, array($url, $column_numbers_to_scrape, $xpaths_of_elements_to_click_in_the_table, $xpaths_to_scrape_in_new_pages, $rows, $text_of_next_btn, $page_moving_times_in_5_threads[1]));
}
...
if ($pages >= 3) {
  $future3 = $runtime3->run(function($url, $column_numbers_to_scrape, $xpaths_of_elements_to_click_in_the_table, $xpaths_to_scrape_in_new_pages, $rows, $text_of_next_btn, $page_moving_times){
    ...
    return $scraped_data;
  }, array($url, $column_numbers_to_scrape, $xpaths_of_elements_to_click_in_the_table, $xpaths_to_scrape_in_new_pages, $rows, $text_of_next_btn, $page_moving_times_in_5_threads[2]));
}


if ($pages >= 4) {
  $future4 = $runtime4->run(function($url, $column_numbers_to_scrape, $xpaths_of_elements_to_click_in_the_table, $xpaths_to_scrape_in_new_pages, $rows, $text_of_next_btn, $page_moving_times){
    require_once 'vendor/autoload.php';
    $host = 'http://selenium-hub:4444/wd/hub';
    $driver = RemoteWebDriver::create($host, DesiredCapabilities::chrome());
    $driver->get($url);
...
if ($pages >= 5) {
  $future5 = $runtime5->run(function($url, $column_numbers_to_scrape, $xpaths_of_elements_to_click_in_the_table, $xpaths_to_scrape_in_new_pages, $rows, $text_of_next_btn, $page_moving_times){
    require_once 'vendor/autoload.php';
    $host = 'http://selenium-hub:4444/wd/hub';
    $driver = RemoteWebDriver::create($host, DesiredCapabilities::chrome());
    $driver->get($url);
