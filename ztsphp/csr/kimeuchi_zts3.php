...
$future1 = $runtime1->run(function($url, $column_numbers_to_scrape, $xpath_of_a, $xpaths_to_scrape_in_a_new_page, $rows, $text_of_next_btn, $page_moving_times){
  ...
  return $scraped_data;
}, array($url, $column_numbers_to_scrape, $xpath_of_a, $xpaths_to_scrape_in_a_new_page, $rows, $text_of_next_btn, $page_moving_times_in_3_threads[0]));
...
if ($pages >= 2) {
  $future2 = $runtime2->run(function($url, $column_numbers_to_scrape, $xpath_of_a, $xpaths_to_scrape_in_a_new_page, $rows, $text_of_next_btn, $page_moving_times){
    ...
    return $scraped_data;
  }, array($url, $column_numbers_to_scrape, $xpath_of_a, $xpaths_to_scrape_in_a_new_page, $rows, $text_of_next_btn, $page_moving_times_in_3_threads[1]));
}
...
if ($pages >= 3) {
  $future3 = $runtime3->run(function($url, $column_numbers_to_scrape, $xpath_of_a, $xpaths_to_scrape_in_a_new_page, $rows, $text_of_next_btn, $page_moving_times){
    ...
    return $scraped_data;
  }, array($url, $column_numbers_to_scrape, $xpath_of_a, $xpaths_to_scrape_in_a_new_page, $rows, $text_of_next_btn, $page_moving_times_in_3_threads[2]));
}
