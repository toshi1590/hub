...
$future1 = $runtime1->run(function($url, $column_numbers_to_scrape, $xpaths_of_elements_to_click_in_the_table, $xpaths_to_scrape_in_new_pages, $rows){
  ...
  return $scraped_data;
}, array($url, $column_numbers_to_scrape, $xpaths_of_elements_to_click_in_the_table, $xpaths_to_scrape_in_new_pages, $rows));


if ($pages >= 2) {
  $future2 = $runtime2->run(function($url, $column_numbers_to_scrape, $xpaths_of_elements_to_click_in_the_table, $xpaths_to_scrape_in_new_pages, $rows, $text_of_next_btn){
    require_once 'vendor/autoload.php';
    ...
    return $scraped_data;
  }, array($url, $column_numbers_to_scrape, $xpaths_of_elements_to_click_in_the_table, $xpaths_to_scrape_in_new_pages, $rows, $text_of_next_btn));
}


if ($pages >= 3) {
  $future3 = $runtime3->run(function($url, $column_numbers_to_scrape, $xpaths_of_elements_to_click_in_the_table, $xpaths_to_scrape_in_new_pages, $rows, $text_of_next_btn){
    require_once 'vendor/autoload.php';
...
if ($pages >= 4) {
  $future4 = $runtime4->run(function($url, $column_numbers_to_scrape, $xpaths_of_elements_to_click_in_the_table, $xpaths_to_scrape_in_new_pages, $rows, $text_of_next_btn){
    require_once 'vendor/autoload.php';
...
if ($pages >= 5) {
  $future5 = $runtime5->run(function($url, $column_numbers_to_scrape, $xpaths_of_elements_to_click_in_the_table, $xpaths_to_scrape_in_new_pages, $rows, $text_of_next_btn){
    require_once 'vendor/autoload.php';
